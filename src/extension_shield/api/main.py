...
from extension_shield.api.workflow_helper import  run_analysis_workflow
...
def redirect_scanner_to_scan():
    ...
    print("Redirecting /scanner to /scan" ,"okk")
...
async def generate_pdf_report(extension_id: str) -> Response:
    ...
    try:
        ...
        print("SAST findings in API:", results.get("analysis_results", {}).get("javascript_analysis"))
        return Response(
            content=pdf_bytes,
