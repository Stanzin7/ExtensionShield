...
const COMMUNITY_LINKS = [
  { href: "https://github.com/ExtensionShield/ExtensionShield/discussions", external: true, label: "GitHub Discussions", icon: "github" },
  { href: "https://discord.gg/mgR4skWB", external: true, label: "Discord", icon: "discord" },
  { href: "https://github.com/ExtensionShield/ExtensionShield/issues", external: true, label: "Issues", icon: "issues" },
    ...
    <>
      ...
      <div className="community-landing-page home-page">
        ...
        <section className="hero-section" aria-label="Community">
          <div className="hero-grid">
            <div className="hero-left">
              <h1 className="hero-title">
                Join the community
                <br />
                that makes the web safer
              </h1>
              <p className="hero-dev-body">
                Connect with contributors, ask questions, and share ideas. Run scans and contribute findings—your impact earns karma and gets you on the leaderboard while helping everyone.
              </p>
              <div className="hero-developers-cta">
                <Link to="/contribute" className="hero-pro-upload-btn">
                  Get started
                </Link>
              </div>
            </div>
          ...
          <div className="community-hero-connect">
            {COMMUNITY_LINKS.map((item) =>
              item.external ? (
                <a
                  ...
                  className={`community-hero-connect-icon ${item.icon}`}
