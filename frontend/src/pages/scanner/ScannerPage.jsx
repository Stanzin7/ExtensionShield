  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! ExtensionShield allows you to scan any Chrome extension from the Chrome Web Store before installing it. Simply paste the extension URL to get an instant security analysis."
        }
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      <SEOHead
        ...
        description="Free extension risk check by URL. Get risk score, permissions, privacy and governance signals. See if a Chrome extension is safe before you install."
        pathname="/scan"
        ogType="website"
